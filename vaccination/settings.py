...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'vax.my_context_processor.date_and_version',
            ],
        },
    },
]
...
# konfiguracja bazy danych jest w pliku local_settings.py
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "static")  # ścieżka do folderu z plikami statycznymi
]
STATIC_URL = '/static/'
